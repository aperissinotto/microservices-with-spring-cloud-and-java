package br.com.perissinotto.controllers;

import br.com.perissinotto.exception.UnsupportedMathOperationException;
import br.com.perissinotto.math.SimpleMath;
import br.com.perissinotto.request.converters.NumberConverter;
...
public class MathController {
    ...
    public Double subtract(
        ...
        if (!NumberConverter.isNumeric(numberOne) || !NumberConverter.isNumeric(numberTwo))
            throw new UnsupportedMathOperationException("Please set a numeric value!");
        return math.subtract(NumberConverter.convertToDouble(numberOne),
                NumberConverter.convertToDouble(numberTwo));
    }
